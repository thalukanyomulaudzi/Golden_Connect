...
namespace Design370
{
    ...
    public partial class SupplierOrders_View : Form
    {
        public static bool edit;
        public SupplierOrders_View()
        {
            InitializeComponent();
        }

        private void SupplierOrders_View_Load(object sender, EventArgs e)
        {
        ...
        private void SupplierOrders_View_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (textBox1.Enabled)
            {

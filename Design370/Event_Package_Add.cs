        ...
        private void Event_Package_Add_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dBConnection.IsConnect())
                {
                    ...
                    serviceTypeID = " ";
                    string query = "SELECT service_type_id FROM service_type WHERE service_type_name = 'Event'";
                    ...
                    productTypeID = " ";
                    query = "SELECT product_type_id FROM product_type WHERE product_type_name = 'Event'";
                    command = new MySqlCommand(query, dBConnection.Connection);
                    reader = command.ExecuteReader();
                    reader.Read();
